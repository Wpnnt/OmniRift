...
interface CanvasState {
  ...
  addAgent: (params?: { label?: string; cwd?: string; provider?: "claude" | "codex" | "hermes" | "opencode"; providerConfig?: { provider: string; model: string }; persona?: string; position?: { x: number; y: number }; targetFloorId?: string }) => AgentNode;
  addSubagent: (params: {
    role: string;
    label: string;
    description?: string;
